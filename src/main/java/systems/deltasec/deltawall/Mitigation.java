...
public class Mitigation {
    ...
    private static final String DUMP_COMMAND = "tcpdump -i "+ DeltaWall.ETH_INTERFACE+" -n udp";
    ...
    public static synchronized void mitigate(long endTime){
        ...
        if (logWriter == null){
            System.out.println(DeltaWall.PREFIX() + "! Fatal Error !  - unable to create log file stream...");
            return;
        }
